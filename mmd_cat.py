...
if  __name__ == '__main__':
    ...
    G_decoder_ = Decoder(input_size  = 64, noise_dim = args.noise_dim, num_chan=3, hid_dim= 64, bn=False)
    D_encoder_ = Encoder(input_size = 64, num_chan = 3, hid_dim = 64,  out_dim = args.noise_dim, bn=False)
    D_decoder_ = Decoder(input_size  = 64, noise_dim = args.noise_dim, num_chan=3, hid_dim= 64, bn=False)
    ...
    with h5py.File(h5dataFile, 'r') as h5_data:
        ...
        model_root, model_name = 'model', 'mmd_cat'
